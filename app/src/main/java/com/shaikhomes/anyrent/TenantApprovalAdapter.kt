...
class TenantApprovalAdapter(
    private val context: Context,
    private val leadsList: ArrayList<TenantList>,
    private val isAdmin: Boolean? = false
) :
    RecyclerView.Adapter<TenantApprovalAdapter.LeadViewHolder>() {
    private var filteredList: MutableList<TenantList> = leadsList.toMutableList()

    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): TenantApprovalAdapter.LeadViewHolder {
        val view: View =
            LayoutInflater.from(context).inflate(R.layout.tenant_approval_layout, parent, false)
    ...
    fun setApprovalClickListener(leadList: (TenantList) -> Unit) {
    ...
    inner class LeadViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        var approve: AppCompatButton = itemView.findViewById<AppCompatButton>(R.id.approve)
