...
import com.shaikhomes.anyrent.ui.utils.getFutureDate
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        activityTenantOverviewBinding.apply {
            ...
            btnChangeRoom.setOnClickListener {
                val intent = Intent(this@TenantOverview, SwapBedsActivity::class.java)
                intent.putExtra("swap_tenant", Gson().toJson(tenantList))
                startActivity(intent)
                finish()
            }
