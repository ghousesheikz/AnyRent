...
import com.shaikhomes.anyrent.ui.customviews.LoadDialog
import com.shaikhomes.anyrent.ui.customviews.dismissProgress
import com.shaikhomes.anyrent.ui.customviews.showProgress
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.txtRegister.setOnClickListener {
            startActivity(
                Intent(
                    this@LoginActivity,
                    com.shaikhomes.anyrent.ui.UserRegister::class.java
                )
            )
            finish()
        }
